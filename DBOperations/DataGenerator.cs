        ...
        public static void Initialize(IServiceProvider serviceProvider)
        {
            using (var context = new LibraryDbContext(serviceProvider.GetRequiredService<DbContextOptions<LibraryDbContext>>()))
            {
                ...
                context.Members.AddRange(
                    #region Member Data
                    new Member{Name = "Ailee",      Surname = "Roggero",            BirthDay = new DateTime(1992, 07, 06), Status = true, City = "Sarkand"},
                    new Member{Name = "Sharona",    Surname = "Wearing",            BirthDay = new DateTime(1997, 09, 28), Status = true, City = "Maghār"},
                    new Member{Name = "Gallard",    Surname = "Kunneke",            BirthDay = new DateTime(1991, 07, 01), Status = true, City = "Mbandjok"},
                    new Member{Name = "El",         Surname = "Nathon",             BirthDay = new DateTime(1995, 05, 12), Status = true, City = "Molinos"},
                    new Member{Name = "Ginni",      Surname = "Wroth",              BirthDay = new DateTime(1995, 08, 20), Status = true, City = "Bakung Utara"},
                    new Member{Name = "Trula",      Surname = "Sturman",            BirthDay = new DateTime(1991, 07, 21), Status = true, City = "Ganggawang"},
                    new Member{Name = "Lon",        Surname = "Luty",               BirthDay = new DateTime(1991, 10, 19), Status = true, City = "Tlumach"},
                    new Member{Name = "Jamison",    Surname = "Sturgess",           BirthDay = new DateTime(1996, 01, 03), Status = true, City = "Kebonbencoy"},
                    new Member{Name = "Roarke",     Surname = "Painswick",          BirthDay = new DateTime(1996, 01, 16), Status = true, City = "Vanino"},
                    new Member{Name = "Jennee",     Surname = "Van Salzberger",     BirthDay = new DateTime(1992, 05, 07), Status = true, City = "Lemenhe"},
                    new Member{Name = "Dory",       Surname = "Lille",              BirthDay = new DateTime(1991, 03, 15), Status = true, City = "Luocun"},
                    new Member{Name = "Craig",      Surname = "Kyffin",             BirthDay = new DateTime(1999, 02, 01), Status = true, City = "Xankandi"},
                    new Member{Name = "Emelda",     Surname = "Edmons",             BirthDay = new DateTime(1998, 05, 18), Status = true, City = "Zhengwan"},
                    new Member{Name = "Madlen",     Surname = "Colbert",            BirthDay = new DateTime(1996, 06, 13), Status = true, City = "Chojnów"},
                    new Member{Name = "Sandra",     Surname = "Ishchenko",          BirthDay = new DateTime(1996, 03, 26), Status = true, City = "Nový Knín"},
                    new Member{Name = "Norene",     Surname = "Stroud",             BirthDay = new DateTime(1996, 03, 11), Status = true, City = "Drásov"},
                    new Member{Name = "Phil",       Surname = "Tunder",             BirthDay = new DateTime(2000, 07, 01), Status = true, City = "Meishan"},
                    new Member{Name = "Ardeen",     Surname = "Blatherwick",        BirthDay = new DateTime(1997, 09, 25), Status = true, City = "Jetis"},
                    new Member{Name = "Killie",     Surname = "Mottershaw",         BirthDay = new DateTime(1992, 03, 23), Status = true, City = "Uluarang"},
                    new Member{Name = "Drusi",      Surname = "Navan",              BirthDay = new DateTime(1991, 08, 22), Status = true, City = "Krajan"},
                    new Member{Name = "Bronnie",    Surname = "Jori",               BirthDay = new DateTime(1991, 11, 03), Status = true, City = "Kapunduk"},
                    new Member{Name = "Edmon",      Surname = "Rumbold",            BirthDay = new DateTime(2000, 10, 03), Status = true, City = "Sanxing"},
                    new Member{Name = "Domeniga",   Surname = "Gilbride",           BirthDay = new DateTime(1994, 09, 28), Status = true, City = "Křižanov"},
                    new Member{Name = "Morgan",     Surname = "Wigan",              BirthDay = new DateTime(1997, 10, 12), Status = true, City = "Manama"},
                    new Member{Name = "Sigismond",  Surname = "Huntingdon",         BirthDay = new DateTime(1996, 04, 07), Status = true, City = "Oslo"}
                    #endregion
                    );
                context.Borrowings.Add(
                    new Borrowing
                    {
                        BookId = 1,
                        BorrowerId = 1,
